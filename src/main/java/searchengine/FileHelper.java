...
public class FileHelper {
  ...
  /**
   * Reads a standard Java config file {@code config.properties}, expecting it to contain a line of
   * the form {@code database=path}. It then returns {@code path}.
   *
   * @return The path assigned to the {@code database} attribute in {@code config.properties}.
   */
