...
public abstract class InvertedIndex implements Index {
    ...
    /**
     * Returns the set of websites which contains the query String,
     * returns null if the map does not contain the key.
     * @param query The query
     * @return the Set of websites that contain the query word, 
     * or null if the query word is not among the map keys.  
     */
    @Override
