...
public abstract class InvertedIndex implements Index {
    ...
    /**
     * Takes a list of websites and creates a map. The keys are the words contained in these
     * websites, the value is a list of all the websites containing that key.
     * 
